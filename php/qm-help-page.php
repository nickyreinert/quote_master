...
function mlw_quotes_generate_help_page()
{
	...
	";
	$mlw_quotes_version = get_option('mlw_quotes_version');
	add_meta_box("wpss_mrts", 'Support', "mlw_quotes_wpss_mrt_meta_box3", "mlw_quotes_wpss3");
	add_meta_box("wpss_mrts", 'My Local Webstop Services', "mlw_quotes_dashboard_services", "mlw_quotes_wpss6");
	add_meta_box("wpss_mrts", 'Contribution', "mlw_quotes_wpss_mrt_meta_box4", "mlw_quotes_wpss4");
	add_meta_box("wpss_mrts", 'News From My Local Webstop', "mlw_quotes_wpss_mrt_meta_box5", "mlw_quotes_wpss5");
	?>
	<!-- css -->
	<style type="text/css">
		div.mlw_quotes_email_support {
		text-align: left;
		}
...
function mlw_quotes_dashboard_services()
{
	?>
	<div>
...
function mlw_quotes_wpss_mrt_meta_box3()
{
	$mlw_quotes_email_message = "";
	$mlw_quotes_version = get_option('mlw_quotes_version');
	if(isset($_POST["action"]))
	{
		$mlw_quotes_email_success = $_POST["action"];
		$mlw_quotes_user_name = $_POST["username"];
		$mlw_quotes_user_email = $_POST["email"];
		$mlw_quotes_user_message = $_POST["message"];
		$mlw_quotes_current_user = wp_get_current_user();
		...
		if ($mlw_quotes_email_success == 'update')
		{
			...
			wp_mail('fpcorso@mylocalwebstop.com' ,'Support From Quote Master Plugin', $mlw_quotes_message);
			$mlw_quotes_email_message = "**Message Sent**";
		}
	}
	?>
	<div class='mlw_quotes_email_support'>
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?page=mlw_quotes_help" method='post' name='emailForm' onsubmit='return mlw_validateForm()'>
	...
	<tr>
	<td><span name='mlw_support_message' id='mlw_support_message' style="color: red;"><?php echo $mlw_quotes_email_message; ?></span></td>
	</tr>
	<tr>
...
function mlw_quotes_wpss_mrt_meta_box4()
{
	?>
	<div>
	<table width='100%'>
	<tr>
	<td align='left'>
	Quote Master is and always will be a free plugin. I have spent a lot of time and effort developing and maintaining this plugin. If it has been beneficial to your site, please consider supporting this plugin by making a donation.
	</td>
	</tr>
	<tr>
	<td>&nbsp;</td>
...
function mlw_quotes_wpss_mrt_meta_box5()
{
	?>
	<div>
	<table width='100%'>
